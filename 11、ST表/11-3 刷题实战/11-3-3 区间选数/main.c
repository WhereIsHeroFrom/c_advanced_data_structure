...
//////////////////////////////////////////ST表模板////////////////////////////////////////////
SparseTable st;
SparseTable st_min, st_max;  // 全局变量，避免栈溢出
...
int main() {
    ...
    SparseTable_Init(&st_min, n, arr, cmpMin);
    SparseTable_Init(&st_max, n, arr, cmpMax);
    ...
    while (m--) {
        ...
        l--;
        r--;
        minsum += SparseTable_GetValue(&st_min, SparseTable_Query(&st_min, l, r));
        maxsum += SparseTable_GetValue(&st_max, SparseTable_Query(&st_max, l, r));
    }
    printf("%lld %lld\n", minsum, maxsum);
    return 0;
}